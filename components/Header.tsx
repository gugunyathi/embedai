...
export const Header: React.FC = () => {
  return (
    <header className="py-6 border-b border-white/5 bg-slate-900/50 backdrop-blur-md sticky top-0 z-40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold tracking-tight">AI Multi-Format Studio</h1>
            <p className="text-xs text-slate-400 uppercase tracking-widest font-medium">Professional Assets Generator</p>
          </div>
        </div>
